...
public class Solution292 {
     ...
     * <p>
     * 3.但是如果不是4倍数的话，就可以控制将4个留给对手，那么自己必定会赢。
     * 比如7，那就先把后四个排除，剩下3个，自己都拿走，就将四个僵局留给对手。
     * 比如13，将3*4剪掉，第一次自己拿走1个，后几轮对手不管哪几个，你都可以和他配对成4个，然后把最后4个留给他。
     * <p>
     * 4.如果刚好是4的倍数，比如8，对方很容易将4的僵局留给你，将后面四个先排除，前四个你作为先手不管拿1-3几个，对面都可以和你加起来等于4，从而把后四个留给你。
     * <p>
     * 所以把n除以4，如果整除，那就必定会输。相反，总会赢。
     * <p>
     * 还有递推关系：dp[i]=!dp[i-1]||!dp[i-2]||!dp[i-3], dp[i]表示剩余i块 你先拿 能否胜利
     *
     * @param n
     * @return
     */
